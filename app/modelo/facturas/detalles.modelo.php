<?php
/*Creado para conectar con la BD y ver los detalles de las facturas del lado del administrador
 */
require_once "./conexion.php";

class DetallesFacturaModelo
{
  ...
  {try 
    {
      ...
      $datos = Conexion::connect()->prepare("SELECT * FROM detalles_factura");
